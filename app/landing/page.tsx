    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 px-8 py-4 flex items-center justify-between">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl shadow-md transition"
        >
          Iniciar sesión
        </button>
      </nav>
      ...
      {/* Hero */}
      <section className="pt-32 pb-24 px-8 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-96 h-96 bg-white rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-white rounded-full blur-3xl"></div>
        </div>
        <div className="max-w-5xl mx-auto relative z-10 flex items-center gap-16">
          <div className="flex-1">
            ...
            <div className="flex gap-3 mt-8">
              <button
                onClick={() => router.push("/login")}
                className="bg-white text-blue-700 font-bold px-7 py-3.5 rounded-2xl shadow-xl hover:shadow-2xl transition text-sm"
              >
                Comenzar ahora →
              </button>
              <button
                onClick={() => router.push("/login")}
                className="border border-white/40 text-white font-medium px-7 py-3.5 rounded-2xl hover:bg-white/10 transition text-sm backdrop-blur-sm"
              >
                Iniciar sesión
              </button>
            </div>
      ...
      <section className="py-20 px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">Funciones</span>
            <h2 className="text-4xl font-extrabold text-gray-900 mt-4">Todo lo que necesitas</h2>
      ...
      <section className="py-20 px-8 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">¿Cómo funciona?</span>
          <h2 className="text-4xl font-extrabold text-gray-900 mt-4 mb-12">Tres pasos para empezar</h2>
      ...
      {/* CTA Final */}
      <section className="py-20 px-8 bg-gradient-to-br from-blue-700 to-blue-500 text-white text-center">
        ...
        <button
          onClick={() => router.push("/login")}
          className="bg-white text-blue-700 font-bold px-10 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition text-base"
        >
